    ...
    def render(context)
      ...
      if @img
        ...
        if @poster && error.nil?
          ...
          cdn = ''
          %Q{<div class="animated_gif_container"><div class="animated_gif_frame" data-caption="GIF#{size}"><img class="animated_gif" src="#{cdn}#{@poster}" data-source="#{cdn}#{@img}"></div></div>}
        else
